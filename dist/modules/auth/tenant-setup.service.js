...
export async function createTenantDatabase(tenantDbName) {
    try {
        console.log(`[TenantSetup] Criando banco de dados: ${tenantDbName}...`);
        ...
        console.log(`[TenantSetup] Banco ${tenantDbName} criado. Rodando tabelas...`);
        ...
        console.log(`[TenantSetup] Tabelas criadas com sucesso em ${tenantDbName}!`);
    }
    catch (error) {
        console.error(`[TenantSetup] Erro ao configurar tenant:`, error);
